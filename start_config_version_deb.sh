...
install_essential_programs() {
    ...
    echo ""
    sleep 1
    sudo apt install qbittorrent gparted neofetch cpufetch gimp inxi gnome-tweaks ubuntu-restricted-extras mesa-utils git libu2f-udev libfuse2 software-properties-common vlc ffmpeg -y
    sudo apt install -f
